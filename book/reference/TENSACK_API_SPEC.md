...
- Current Rust implementation uses opaque offset cursors over live `.tenb`
...
[TENSACK_PLAN_SPEC.md](TENSACK_PLAN_SPEC.md).
...
- `TensackDatabase::insert`
- `TensackDatabase::put`
- `TensackDatabase::delete_by_id`
- `TensackDatabase::get`
- `TensackDatabase::get_by`
- `TensackDatabase::get_many_by`
- `TensackDatabase::upsert`
- `TensackDatabase::patch_by_id`
- `TensackDatabase::scan`
- `TensackDatabase::count`
