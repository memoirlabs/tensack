...
- App entrypoint at `apps/sixpack`.
...
- `.6` table preamble encoding
- `.6` row operation encoding and decoding
- put rows and delete tombstones
- binary-packed `.6b` v2 cache encoding and decoding
- legacy text `.6b` decoding for rebuild migration
