...
- [book/00-atlas.md](../../book/00-atlas.md) — canonical repository map, current layout, and target layout.
...
- [apps/landing-page/src/pages/index.astro](../../apps/landing-page/src/pages/index.astro) — static docs app for the current backend map and storage layout.
...
- The current repo and storage atlas is tracked in [book/00-atlas.md](../../book/00-atlas.md).
